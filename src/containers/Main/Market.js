                ...
                <div className="markets">
                  ...
                  {settings.markets &&
                    (settings.markets || [])
                      ...
                      .sort((a, b) => {
                        return +new BigNumber(b.totalSupplyUsd).minus(new BigNumber(a.totalSupplyUsd)).toString(10)
                      })
                      .slice(0, 3)
                      .map(item => (
                        <div className="progress" key={item.underlyingSymbol}>
                          <LineProgressBar
                            ...
                            percent={!new BigNumber(totalSupply).isZero() ? new BigNumber(item.totalSupplyUsd).div(new BigNumber(totalSupply)).times(100).dp(2, 1).toNumber() : 0}
                            type="market"
                          />
                        </div>
                      ))}
                    ...
                    (settings.markets || [])
                      ...
                      .map(item => (
                        <div className="progress" key={item.underlyingSymbol}>
                          <LineProgressBar
                            label={item.underlyingSymbol}
                            percent={!new BigNumber(totalBorrow).isZero() ? new BigNumber(item.totalBorrowsUsd).div(new BigNumber(totalBorrow)).times(100).dp(2, 1).toNumber() : 0}
                            type="market"
                          />
                        </div>
                      ))}
                    ...
                    .map((item, index) => (
                      ...
                      >
                        ...
                        <Col xs={{ span: 24 }} lg={{ span: 4 }} className="borrow-apy right">
                          ...
                          <p className="item-value">
                            {new BigNumber(item.borrowStrikeApy).dp(2, 1).toString(10)}%
                          </p>
                        </Col>
                      </Row>
                    ))}
